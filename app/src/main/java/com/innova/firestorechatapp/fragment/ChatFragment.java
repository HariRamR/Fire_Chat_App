...
import com.innova.firestorechatapp.model.ChatModel;
import com.innova.firestorechatapp.model.Message;
import com.innova.firestorechatapp.model.NotificationModel;
import com.innova.firestorechatapp.model.UserModel;
import com.innova.firestorechatapp.photoview.ViewPagerActivity;
import okhttp3.Call;
...
//    private SimpleDateFormat dateFormatDay = new SimpleDateFormat("yyyy-MM-dd");
    private SimpleDateFormat dateFormatHour = new SimpleDateFormat("hh:mm aa");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.msg_input).setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus) {
                    Util9.hideKeyboard(Objects.requireNonNull(getActivity()));
                }
            }
        });
    ...
    void sendGCM(){
        ...
        for ( Map.Entry<String, UserModel> elem : userList.entrySet() ){
            ...
            Request request = new Request.Builder()
                    ...
                    .addHeader("Authorization", "key=AAAA4sQFLCI:APA91bEVz_XlxYgEj9ssBLyZPOr7VIdVPbMLosfebeUvN0ZX3vzEBnaiVbi9vFb2mwU98s1eEwGL--GnT2wmOHOkfiaSDQ_L1jcJzQ4clXz49iHqX2Ff8sfLLk8B981Sq_sGbgm6U-h_")
    ...
    public void onActivityResult(final int requestCode, int resultCode, Intent data) {
        ...
        // small image
        if (isVisible()){
            Glide.with(getContext()).asBitmap().load(fileUri).apply(new RequestOptions().override(150, 150)).into(new SimpleTarget<Bitmap>() {
            @Override
...
//            setReadCounter(message, messageViewHolder.read_counter);
            ...
            if ("2".equals(message.getMsgtype())) {                                      // file transfer
                ...
                if (isVisible()) {
                    Glide.with(getContext()).load(storageReference.child("filesmall/" + message.getMsg()))
                            .apply(new RequestOptions().override(1000, 1000)).into(messageViewHolder.img_item);
                }
            }
            ...
            if (!myUid.equals(message.getUid())) {
                ...
                if (userModel.getUserphoto()==null) {
                    ...
                    if (isVisible()) {
                        Glide.with(getContext()).load(R.drawable.profile_img).apply(requestOptions).into(messageViewHolder.user_photo);
                    }
                } else{
            ...
            }else if (message.getMsgtype().equals("0")){

                setReadCounter(message, messageViewHolder.doubleTickIcon);
            }
...
//        void setReadCounter (Message message, final TextView textView) {
        void setReadCounter (Message message, final ImageView doubleTick) {

            if (userCount == 2){

                Drawable drawable = doubleTick.getDrawable().mutate();
                ...
                if (cnt > 0) {
                    ...
                    doubleTick.setImageDrawable(drawable);
                } else {

                    drawable.setColorFilter(new PorterDuffColorFilter(getResources().getColor(R.color.blue), PorterDuff.Mode.SRC_IN));
                    doubleTick.setImageDrawable(drawable);
                }
            }
        }
    ...
    private class MessageViewHolder extends RecyclerView.ViewHolder {
        public ImageView user_photo, doubleTickIcon;
        ...
        public MessageViewHolder(View view) {
            ...
            doubleTickIcon = view.findViewById(R.id.is_seen_icon);
